...
|C| [Hexacoin Jam](https://codingcompetitions.withgoogle.com/codejam/round/000000000019ff31/00000000003b4bc5)| [PyPy](./Virtual%20World%20Finals/hexacoin_jam.py) | _O(B^(D + 1) * D + N^2 * D)_ | _O(B^(D + 1))_ | Hard || Hash, Math
