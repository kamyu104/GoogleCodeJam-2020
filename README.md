...
|C| [Oversized Pancake Choppers](https://codingcompetitions.withgoogle.com/codejam/round/000000000019fef4/00000000003179a1)| [PyPy](./Round%201C/oversized_pancake_choppers.py) | _O(D * N * log(max(A)))_ | _O(D * N)_ | Hard || Sort, Hash Table, Euclidean Algorithm, Binary Search, Greedy
