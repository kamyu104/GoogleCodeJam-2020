...
|D| [Emacs++](https://codingcompetitions.withgoogle.com/codejam/round/000000000019ffb9/000000000033893b)| [PyPy*](./Round%202/emacs++.py) | _O(K * (logK)^2 + QlogK)_ | _O(KlogK)_ | Hard || Tree, Middle Line, Lazy Construction, Recursion, Dijkstra's Algorithm
