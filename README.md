...
|B| [Blindfolded Bullseye](https://codingcompetitions.withgoogle.com/codejam/round/000000000019fef2/00000000002d5b63)| [Python](./Round%201B/blindfolded_bullseye.py) [Python](./Round%201B/blindfolded_bullseye2.py) | _O(128)_ | _O(1)_ | Medium || Probability, Binary Search, Geometry
|C| [Join the Ranks](https://codingcompetitions.withgoogle.com/codejam/round/000000000019fef2/00000000002d5b64)| [Python](./Round%201B/join_the_ranks.py) [Python](./Round%201B/join_the_ranks2.py) [Python](./Round%201B/join_the_ranks3.py) [Python](./Round%201B/join_the_ranks4.py) [Python](./Round%201B/join_the_ranks5.py) | _O(R * S)_ | _O(1)_ | Hard || Invariant, Sort, One-Liner
