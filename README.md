...
|C| [Join the Ranks](https://codingcompetitions.withgoogle.com/codejam/round/000000000019fef2/00000000002d5b64)| [Python](./Round%201B/join_the_ranks.py) [Python](./Round%201B/join_the_ranks2.py) | _O(R^2 * S)_ | _O(R * S)_ | Hard || Invariant, Sort
